                ...
                <div class="card text-left">
                    <div class="card-body">
                        @if ($urlPrefix != 'super-admin')
                            <a href="{{ url($urlPrefix.'/add-ecampaign') }}" type="button" class="btn btn-primary"> Send Gift</a>
                        @endif
                        <a href='{{url("$urlPrefix/eproducts")}}' type="button" class="btn btn-primary">View Gift</a>
    ...
    <script type="text/javascript">
        ...
        function getTable() {
            table = $('#table').DataTable({
                ...
                lengthChange: false,
                ajax: {
                    url: '{{ url("$urlPrefix/ecampaigns") }}', // need to change here url
                    type: "GET",
                },
                columns: [{
                        data: 'DT_RowIndex',
