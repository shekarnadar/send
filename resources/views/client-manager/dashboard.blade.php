                        ...
                        <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                            <div class="card-body text-center"><i class="i-Add-User"></i>
                                <div class="content">
                                    ...
                                    <p class="text-primary text-24 line-height-1 mb-2">{{ $totalGiftSentCount }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-6 col-sm-6">
                        <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                            <div class="card-body text-center"><i class="i-Cash-Register"></i>
                                <div class="content">
                                    <p class="text-muted mt-2 mb-0">Campaign</p>
                                    <p class="text-primary text-24 line-height-1 mb-2">{{ @$campaignsCount }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                            <div class="card-body text-center"><i class="i-Checkout-Basket"></i>
                                <div class="content">
                                    ...
                                    <p class="text-primary text-24 line-height-1 mb-2">{{ $totalGiftRedeemedCount }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                            <div class="card-body text-center"><i class="i-Gift-Box"></i>
                                <div style="margin-left: 60px;">
                                    ...
                                    <p class="text-primary text-24 line-height-1 mb-2">₹{{ $maximumBudget }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                            <div class="card-body text-center"><i class="i-Gift-Box"></i>
                                <div style="margin-left: 60px;">
                                    ...
                                    <p class="text-primary text-24 line-height-1 mb-2">₹{{ $reedemedBudget }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
