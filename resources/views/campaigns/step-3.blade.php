                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-check">
                                                <center>
                                                    ...
                                                    <input type="checkbox" class="form-check-input checkEmailWatsapp" id="checkEmail" onchange="selectWhatsApp()" name="email"><label for="checkEmail"><img src="{{ url('assets/images/email.png') }}" style="heigh:50px;width:100px;" /></label>
                                                    <label class="form-check-label" for="formrow-customCheck">Email</label>
                                                </center>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <center>
                                                <input type="checkbox" class="form-check-input checkEmailWatsapp" id="checkWhatsApp" name="whatsapp" onchange="myFunction1()">
                                                <label for="checkWhatsApp">
                                                    <img src="{{ url('assets/images/whatsapp.png') }}" style="heigh:50px;" />
                                                </label>
                                        ...
                                        <div class="card-body" id="text" style="display:none">
                                            <div class="col-lg-12">
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="col-md-4"> <input class="campaigntype" type="radio" name="template_type" value="1" checked="" onclick="getEmailTemplate(1)">&nbsp;Template1</div>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <div class="col-md-4"><input class="campaigntype" type="radio" name="template_type" value="2" onclick="getEmailTemplate(2)">&nbsp;Template2</div>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <div class="col-md-4"><input class="campaigntype" type="radio" name="template_type" value="3" onclick="getEmailTemplate(3)">&nbsp;Template3</div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mt-1">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" name="subject" type="text" value="" id="subject" placeholder="Enter Subject">
                                            ...
                                            <textarea rows="10" class="form-control" name="email_description" id="email_description" placeholder="Enter Email Description">{{ $templates['template_text'] }}</textarea>
                                            <div class="container-fluid" id="text2" style="display:none">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div>
                                                            <textarea type='text' value='' name='dateA' id='dateF' style="width:350px;height:100%;padding:10px;border:1px solid #aaaaaa;"> </textarea>
                                                            <input type='hidden' value='' name='dateA' id='dateD'>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div style="width:350px;height:100%;padding:10px;border:1px solid #aaaaaa;">
                                                            <div class="checkbox-group required">
                                                                <div class="form-check">
                                                                    <input type="checkbox" class="date" data-value='Dear rahu,Please Click Here to redeem the gift. Thank you' data-formatted="Dear rahu,Please Click Here to redeem the gift. Thank you" id='something' name="fooby[1][]" checked> - Dear
                                                                    Rahu,Please Click Here to redeem the gift. Thank you
                                                                </div>
                                                                <br>
                                                                <div class="form-check">
                                                                    <input type="checkbox" class="date" data-value='Dear Raju,Please Click Here to redeem the gift. Thank you' data-formatted="Dear Raju,Please Click Here to redeem the gift. Thank you" id='something' name="fooby[1][]"> - Dear
                                                                    Raju,Please Click Here to redeem the gift. Thank you
                                                                </div>
                                                                <br>
                                                                <div class="form-check">
                                                                    <input type="checkbox" class="date" data-value='Dear Ravi,Please Click Here to redeem the gift. Thank you' data-formatted="Dear Ravi,Please Click Here to redeem the gift. Thank you" id='something' name="fooby[1][]"> - Dear
...
<script>
    ...
    $('#form').on('submit', function(e) {
        ...
        $.ajax({
            type: "post",
            url: "{{ url($urlPrefix.'/save-campaign-final-step') }}",
            data: formValue,
            cache: false,
            contentType: false,
            processData: false,
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    setTimeout(function() {
                        window.location.href = "{{ url($urlPrefix.'/campaigns') }}";
                    }, 2000);
                } else {
