...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="{{url('assets/new_file/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
  <link href="{{url('assets/new_file/vendor/bootstrap-icons/bootstrap-icons.css')}}" rel="stylesheet">
  <link href="{{url('assets/new_file/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet">
  <link href="{{url('assets/new_file/vendor/aos/aos.css')}}" rel="stylesheet">
  <link href="{{url('assets/new_file/vendor/glightbox/css/glightbox.min.css')}}" rel="stylesheet">
  <link href="{{url('assets/new_file/vendor/swiper/swiper-bundle.min.css')}}" rel="stylesheet">

  <!-- Template Main CSS File -->
  <link href="{{url('assets/new_file/css/main.css')}}" rel="stylesheet">
  <link href="{{url('assets/new_file/css/style.css')}}" rel="stylesheet">
  <link href="{{url('assets/new_file/css/responsive.css')}}" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="header d-flex align-items-center">
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <a href="#" class="logo d-flex align-items-center">
        <img src="{{url('landing/images/send-color-logo.png')}}">
      </a>
  ...
  <section id="hero" class="hero">
      ...
      <div class="container">
        <div class="row justify-content-flex-start">
          <div class="col-lg-6 text-left">
            <h2 data-aos="fade-down">Drive Customer Loyalty via Gift
              Marketing <span>Automation</span></h2>
    ...
    <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
      ...
      <div class="carousel-item active" style="background-image:url({{url('landing/images/banner.webp)')}}"></div>
    </div>
  ...
  <main id="main">
        ...
        <div class="row justify-content-between gy-4">
          <div class="col-lg-12 col-md-12 rating" data-aos="fade">
            ...
            <div class="d-flex align-items-center justify-content-between rating-side">
              <span> <img src="{{url('landing/images/mcaffein.webp')}}"> </span>
              <span><img src="{{url('landing/images/konica.webp')}}"> </span>
              <span> <img src="{{url('landing/images/conductix.webp')}}"></span>
              <span> <img src="{{url('landing/images/metro.webp')}}"></span>
      ...
      <div class="container-fuild">
        ...
        <div class="row">
          <div class="slides-service swiper">
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <div class="testimonial-wrap d-flex">
                  <div class="service-img-box">
                    <img src="{{url('assets/new_file/img/msg.png')}}" class="service-img" alt="">
                  </div>
              ...
              <div class="swiper-slide">
                <div class="testimonial-wrap d-flex">
                  <div class="service-img-box">
                    <img src="{{url('assets/new_file/img/gift.png')}}" class="service-img" alt="">
                  </div>
                  <div class="testimonial-item">
              ...
              <div class="swiper-slide">
                <div class="testimonial-wrap d-flex">
                  <div class="service-img-box">
                    <img src="{{url('assets/new_file/img/node.png')}}" class="service-img" alt="">
                  </div>
                  <div class="testimonial-item">
              ...
              <div class="swiper-slide">
                <div class="testimonial-wrap d-flex">
                  <div class="service-img-box">
                    <img src="{{url('assets/new_file/img/Icon.png')}}" class="service-img" alt="">
                  </div>
                  <div class="testimonial-item">
          ...
          <div class="text-center">
            ...
            <button class="btn-get"><a href="#contact-us" style="color:white;" class="btn-get">get started </a><img src="{{url('assets/new_file/img/ic_play_circle_outline_48px.png')}}"> </button>
          </div>
        </div>
    ...
    <section id="feedback" class="feedback section-bg">
      ...
      <div class="container">
        <div class="col-lg-12 col-md-12 rating" data-aos="fade">
          ...
          <div class="d-flex align-items-center justify-content-between rating-side">
            <span> <img src="{{url('landing/images/feedback1.webp')}}"> </span>
            <span><img src="{{url('landing/images/feedback2.webp')}}"> </span>
            <span> <img src="{{url('landing/images/feedback3.webp')}}"></span>
            <span> <img src="{{url('landing/images/feedback4.webp')}}"></span>
            <span> <img src="{{url('landing/images/feedback5.webp')}}"></span>
          </div>
        </div>
        ...
        <div class="row justify-content-around gy-4">
          <div class="col-lg-5 d-flex flex-column justify-content-center">
            ...
            <div class="icon-box d-flex position-relative align-items-center" data-aos="fade-up" data-aos-delay="100">
              <img src="{{url('assets/new_file/img/Icon1.png')}}">
              <div>
            ...
            <div class="icon-box d-flex position-relative align-items-center" data-aos="fade-up" data-aos-delay="200">
              <img src="{{url('assets/new_file/img/Icon2.png')}}">
              <div>
            ...
            <div class="icon-box d-flex position-relative align-items-center" data-aos="fade-up" data-aos-delay="300">
              <img src="{{url('assets/new_file/img/Icon3.png')}}">
              <div>
          ...
          <div class="col-lg-6 img-bg" style="background-image: url({{url('assets/new_file/img/temp.svg)')}};" data-aos="zoom-in" data-aos-delay="100"></div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide even">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="{{url('assets/new_file/img/giftpack-1.webp')}}" class="gift-img" alt="">
                </div>
              </div>
            </div>
            ...
            <div class="swiper-slide odd">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="{{url('assets/new_file/img/giftpack-2.webp')}}" class="gift-img" alt="">
                </div>
              </div>
            </div>
            <!-- End testimonial item -->
            ...
            <div class="swiper-slide even">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="{{url('assets/new_file/img/giftpack-3.webp')}}" class="gift-img" alt="">
                </div>
              </div>
            </div>
            <!-- End testimonial item -->
            ...
            <div class="swiper-slide odd">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="{{url('assets/new_file/img/giftpack-4.webp')}}" class="gift-img" alt="">
                </div>
              </div>
            </div>
            <!-- End testimonial item -->
            ...
            <div class="swiper-slide even">
              <div class="testimonial-wrap">
                <div class="testimonial-item">
                  <img src="{{url('assets/new_file/img/giftpack-5.webp')}}" class="gift-img" alt="">
      ...
      <div class="container-fuild" data-aos="fade-up">
        ...
        <div class="slides-testimonial swiper">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="card">
                <img src="{{url('landing/images/Marketing_Team.webp')}}" class="card-img-top" alt="...">
                <div class="card-body">
                  <div class="img-div d-flex">
                    <img src="{{url('assets/new_file/img/human.png')}}" class="">
                    <span class="hr-team">
            ...
            <div class="swiper-slide">
              <div class="card">
                <img src="{{url('landing/images/Sales_Team.webp')}}" class="card-img-top" alt="...">
                <div class="card-body">
                  <div class="img-div d-flex">
                    <img src="{{url('assets/new_file/img/human.png')}}" class="">
                    <span class="hr-team">
            ...
            <div class="swiper-slide">
              <div class="card">
                <img src="{{url('landing/images/HR_Team.webp')}}" class="card-img-top" alt="...">
                <div class="card-body">
                  <div class="img-div d-flex">
                    <img src="{{url('assets/new_file/img/human.png')}}" class="">
                    <span class="hr-team">
            ...
            <div class="swiper-slide">
              <div class="card">
                <img src="{{url('landing/images/CXO.webp')}}" class="card-img-top" alt="...">
                <div class="card-body">
                  <div class="img-div d-flex">
                    <img src="{{url('assets/new_file/img/human.png')}}" class="">
                    <span class="hr-team">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row justify-content-center gy-4">
          <div class="col-lg-5 d-flex  justify-content-flex-end">
            <div class="saprate">
              <img src="{{url('landing/images/metro.jpg')}}" class="quate-logo">
            <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="100">
              <img src="{{url('assets/new_file/img/Quote-small.png')}}" class="quate-smal">
         ...
         <div class="col-lg-5 d-flex flex-column justify-content-center position-relative rightside">
          <div class="row d-flex flex-column justify-content-center">
            <div class="col-md-12">
              ...
              <img src="{{url('landing/images/mcaffein.png')}}" class="quate-logo">
            <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="100">
              <img src="{{url('assets/new_file/img/Quote-small.png')}}" class="quate-smal">
              <div class="Quote-para">
            ...
            <div class="col-md-12 mt-md-4 mt-1 BookMyShow">
              ...
              <img src="{{url('landing/images/konica.png')}}" class="quate-logo">
            <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="100">
              <img src="{{url('assets/new_file/img/Quote-small.png')}}" class="quate-smal">
              <div class="Quote-para">
   ...
   <div class="section-bg-overlay"></div> -->
    ...
    <section class="banner" id="contact-us">
      <div class="info d-flex align-items-center">
        <div class="container-fuild d-flex justify-content-center banner-img" style="background-image:url({{url('assets/new_file/img/CTA.png)')}}">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-3 footer-links">
            <h4>Social Media</h4>
            <ul>
              <li><a href="https://instagram.com/send1.in" target="_blank"><img src="{{url('assets/new_file/img/instagram-symbol.png')}}" style="width:25px;"></a>&nbsp;&nbsp;
                <a href="https://www.facebook.com/send1.in" target="_blank"><img src="{{url('assets/new_file/img/facebook-symbol.png')}}" style="width:25px;"></a></li>
            </ul>
          </div>
          <!-- End footer links column-->
  ...
  <!-- Vendor JS Files -->
  <script src="{{url('assets/new_file/vendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
  <script src="{{url('assets/new_file/vendor/aos/aos.js')}}"></script>
  <script src="{{url('assets/new_file/vendor/glightbox/js/glightbox.min.js')}}"></script>
  <script src="{{url('assets/new_file/vendor/isotope-layout/isotope.pkgd.min.js')}}"></script>
  <script src="{{url('assets/new_file/vendor/swiper/swiper-bundle.min.js')}}"></script>
  <script src="{{url('assets/new_file/vendor/purecounter/purecounter_vanilla.js')}}"></script>
  <!--  Main JS File -->
  <script src="{{url('assets/new_file/js/main.js')}}"></script>
