                      ...
                      <form method="post" id="form" action="javascript:void(0)" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                        <label for="example-lname-input" class="form-label">List Name</label>
                                        <input class="form-control" name="lname" type="text" value="" id="lname" placeholder="Enter List Name">
                                        <span id="lname-error" class="error text-danger"></span>
                                    </div>
                        ...
                        <div class="row justify-content-center mt-5">
                            <div class="col-sm-2">
                                <div>
                                    <a href="{{url('super-admin/listname')}}" class="btn btn-primary w-md">Cancel</a>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div>
