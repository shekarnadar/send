            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="p-4">
                        ...
                        <h1 class="mb-3 text-18">Admin Sign In</h1>
                        <form class="mt-4 pt-2" id="form" method="POST" action="javascript:void(0)">
                            <input type="hidden" name="role_id" value="1">
                            @csrf
                            <div class="form-group">
                                <label for="email">Email address</label>
                                <input type="text" name="email" id="email" placeholder="Enter Email" class="form-control form-control-rounded">
                                <div id="email-error" class="error text-danger mt-2"></div>
                            </div>
                            <div class="form-group">
                                <label for="password">Password</label>
                                <input class="form-control form-control-rounded" name="password" type="password" id="password" placeholder="Enter Password">
                                <div id="password-error" class="error text-danger mt-2"></div>
                            </div>
                            <button type="button" class="btn btn-rounded btn-primary btn-block mt-2" id="btnSubmit">Sign In</button>
                        ...
                        <div class="mt-3 text-center">
                            <a href="{{url('')}}" class="text-muted"><u>Login With Client Admin</u></a>
                        </div>
                    </div>
                </div>
