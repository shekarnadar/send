                     ...
                     <div class="col-lg-6">
                        <div>
                           <div class="mb-3">
                              ...
                              <input required class="form-control" name="bulk_import" type="file" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">
