...
<div class="main-header"  style="justify-content:center">
    <div class="logo">
        <img src="{{$client_admin_logo}}" alt="" width="200" height="200">
    </div>
</div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box ">
               <h1 class="mb-sm-0 font-size-18"><center>Product Details</center><br>
               </h1>
           </div>
        </div>
        <div class="col-12">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="ul-product-detail__image">
                                        <img src="{{getImage(@$productDetails->productDefaultImage->image, 'product')}}" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-6">
